...
{ 
 Serial.begin(1000000);
  ...
  motor14.goalPosition(2048);
  delay(50);
}
int reset12,reset10,reset3,reset5,j;
float reset1,reset2,reset4;
int degf=204,deg=512,deg2=512;
float angr1,angr2,angr3,angr5,angr10,angr8,angr9,angr12,angr13,angr14;
float t1=0,t2=0,t3=0,t4=0,t5=0,t6=0,t7=0,t8=0,t9=0,t10=0,t11=0,t12=0,tr=0;
int degf1,degf2=204,degf3=204,degf5=204,degf6=204,degf7,degf8=820,degf9=204,degf10=665,degf11=512,degf13=204,degf14=512,degf12=820;
int f1=1,f2=1,f3=1,f4=1,f5=1,f6=1,f7=1,f8=1;
int T=t1+t2+t3+t4+t5+t6+t7+t8+t9+t10+t11+t12+tr;
void loop() 
{       
  delay(1000);
    while(degf<=358 && f1==1)                        //for hip to come at 15° smoothly
    {
      angr2=-90+(25*t1);
    ...
    T+=t3;
    //end of one leg   
    while(degf6<=358 && f3==1)                        //for hip to come at 15° smoothly
    {
      t4=(millis()/1000.0)-T;
      angr2=-90+(25*t4);
      degf6=map(angr2,-90,90,204,820); 
      angr1=0-(25*t4);
      degf7=map(angr1,-90,90,1024,3072);
   ...
   while(degf5<=358)
    ...
    //second leg
    // START OF THIRD LEG
  while(degf9<=358 && f5==1)                        //for hip to come at 15° smoothly
    {
      t7=(millis()/1000.0)-T;
      angr9=-90+(25*t7);
    ...
    //end of one leg 
    //LEG FOUR  
    while(degf13<=358 && f7==1)                        //for hip to come at 15° smoothly
    {
      t10=(millis()/1000.0)-T;
      angr13=-90+(25*t10);
...
//  //motor14.goalPosition(512);
    ...
    degf=204;deg=512;deg2=512;degf2=204;degf3=512;degf5=204;degf6=204;degf8=512;degf9=204;degf10=665;degf13=204;degf14=2048;degf12=820;
