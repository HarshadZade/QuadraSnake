...
//  delay(50);
  while(1)
  {    
    float angr1=60*sin((1*(3.14*t)/6)+(((1*3.14))/2)+3.14/6);
    int degf1=map(angr1,-60,60,307,717); 
    float angr2=60*sin((1*(3.14*t)/6)+((2*3.14))/2);
    int degf2=map(angr2,-60,60,307,717); 
    float angr3=60*sin((1*(3.14*t)/6)+(((3*3.14))/2)+3.14/6);
    int degf3=map(angr3,-60,60,307,717);  
    float angr4=60*sin((1*(3.14*t)/6)+((4*3.14))/2);
    int degf4=map(angr4,-60,60,307,717); 
    float angr5=60*sin((1*(3.14*t)/6)+(((5*3.14))/2)+3.14/6);
